    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-[#E2E8F0] p-8 shadow-card">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-xs text-[#64748B] hover:text-[#0F172A] transition-colors">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-sm text-[#64748B] mt-6">
          ...
          <Link href="/register" className="text-[#0F172A] font-semibold hover:text-[#FACC15] transition-colors">
            Sign up free
          </Link>
        </p>
      </div>
